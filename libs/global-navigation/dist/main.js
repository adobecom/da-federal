var U=e=>{switch(e.type){case"LinkGroupHeader":return ye(e);case"LinkGroupLink":return ve(e);case"LinkGroupBlue":return he(e);default:return console.error(e),""}},ye=({title:e,classes:r})=>`
  <div role="heading" class="${r.join(",")}">
    <div class="title">${e}</div>
  </div>
`,ve=({iconHref:e,iconAlt:r,title:t,href:n,subtitle:i})=>{let l=r!==null&&e!==null?`
      <picture>
        <img
          loading="lazy"
          src="${e}"
...
`;var h=({text:e,href:r})=>`<a href="${r}">${e}</a>`;var T=({text:e,href:r})=>`
...
`,G=({content:e})=>e,Z=e=>{switch(e.type){case"LinkGroupHeader":case"LinkGroupLink":case"LinkGroupBlue":return U(e);case"Link":return h(e);case"PrimaryCTA":return T(e);case"SecondaryCTA":return b(e);default:return console.error(`Unexpected ColumnItem type ${e}`),""}};var j=e=>[{type:"Brand",imgSrc:"/federal/assets/svgs/adobe-logo.svg",altText:"Adobe .Inc.",render:!0,brandImageOnly:!0,href:new URL("https://www.adobe.com")},[]];var z=({imgSrc:e,altText:r,href:t})=>`
<a href="${t.href}" 
   class="feds-brand"
   aria-label="Adobe"
>
